...
public class EntryWebView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isNetworkStatusAvialable(getApplicationContext())){
            ...
            webView.loadUrl("http://www.visitcyprus.com/index.php/en/practical-information/entry-requirements");
