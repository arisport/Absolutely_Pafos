 ...
 */
public class CategoriesGalleryFragmentFragment extends Fragment {
    ...
    public CategoriesGalleryFragmentFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new CardAdapterCategoriesGallery(this.getActivity());
