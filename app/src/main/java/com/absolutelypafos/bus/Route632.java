...
public class Route632 extends AppCompatActivity {
    ...
    private final LatLng LOCATION_29 = new LatLng(34.77304, 32.42553);
    private final LatLng LOCATION_30 = new LatLng(34.77141, 32.43074);
    ...
    private final LatLng LOCATION_49 = new LatLng(34.70841, 32.57662);
    private final LatLng LOCATION_50 = new LatLng(34.74983, 32.67724);
    private final LatLng LOCATION_51 = new LatLng(34.77097, 32.71602);
  /*  private final LatLng LOCATION_52 = new LatLng(34.67382, 32.60772);
       ...
       // final Marker busstop30= map.addMarker(new MarkerOptions().position(LOCATION_54).title("Bus Stop 57").icon(BitmapDescriptorFactory.fromResource(R.drawable.marker_image)));
        ...
        buttonGeneral.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popupMenu = new PopupMenu(Route632.this, buttonGeneral);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.one) {
                            AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(Route632.this,R.style.AppCompatAlertDialogStyle);
                            alertDialogBuilder .setTitle("Bus Timetable");
                            alertDialogBuilder .setMessage("Paphos - Kouklia - Archimandrita (Mousere village - only upon customer's request)\n" +
                                    "\n" +
                                    ...
                                    "\n" +
                                    "Departures from Archimandrita: \n" +
                                    "07:40, 15:00\n" +
                                    "\n" +
                                    "(Saturday: 07:40, 13:20) \n" +
                                    "\n" +
                                    "* This route passes from the harbour station, posidonos avenue and the Afrodite Hills Hotel and Resort.");
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(map, R.raw.exakosiatriantadio, getApplicationContext());
