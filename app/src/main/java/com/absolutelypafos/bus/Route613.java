...
public class Route613 extends AppCompatActivity {
    ...
    private final LatLng LOCATION_42 = new LatLng(34.74012, 32.48065);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        buttonGeneral.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popupMenu = new PopupMenu(Route613.this, buttonGeneral);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.one) {
                            AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(Route613.this,R.style.AppCompatAlertDialogStyle);
                            alertDialogBuilder .setTitle("Bus Timetable");
                            alertDialogBuilder .setMessage("Karavella (Main Station), Griva Digeni, Athinon, Archiepiskopou Makariou (Geroskipou), Koloni, Acheleia, Timi, Pafos Airport.\n" +
                                    "\n" +
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(map, R.raw.exakosiadekatria, getApplicationContext());
