...
import com.absolutelypafos.adapter.CardAdapterRoutesAirport;
import com.absolutelypafos.adapter.CardAdapterRoutesPaphosCity;

/**
 * A placeholder fragment containing a simple view.
 */
public class AirportRoutesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new CardAdapterRoutesAirport(this.getActivity());
