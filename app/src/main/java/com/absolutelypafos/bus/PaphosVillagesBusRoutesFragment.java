 ...
 */
public class PaphosVillagesBusRoutesFragment extends Fragment {
    ...
    public PaphosVillagesBusRoutesFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new CardAdapterRoutesPaphosVillages(this.getActivity());
